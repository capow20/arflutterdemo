    ...
    public class AzureAnchorLocalizer : DemoScriptBase
    {
        ...
        protected override void OnCloudAnchorLocated(AnchorLocatedEventArgs args)
        {
            ...
            if (args.Status == LocateAnchorStatus.Located)
            {
                ...
                Manager.SendMessageToFlutter("Anchor Located");

                SetBypassCache(true);
            }else if(args.Status == LocateAnchorStatus.NotLocated){
        ...
        {
            Debug.Log("Configuring Session...");
            Debug.Log("AppState: " + currentAppState.ToString());
